...
#define FW_FLAVOR ACM      //uncomment if DEBUG, DEVEL, ALPHA, BETA or RC
...
#define FW_REPOSITORY "github.com/amatos/Prusa-Firmware"
...
#define STRING_CONFIG_H_AUTHOR "(a.matos)" // Who made the changes.
